...
namespace Ranger.Services.Notifications
{
    ...
    public class SendPrimaryOwnerTransferAcceptedEmails : ICommand
    {
        ...
        public SendPrimaryOwnerTransferAcceptedEmails(string transferEmail, string ownerEmail, string transferFirstName, string ownerFirstName, string ownerLastName, string domain, string organizationName)
        {
