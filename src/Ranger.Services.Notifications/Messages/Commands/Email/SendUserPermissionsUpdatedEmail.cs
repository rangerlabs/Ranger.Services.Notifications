...
namespace Ranger.Services.Notifications
{
    ...
    public class SendUserPermissionsUpdatedEmail : ICommand
    {
        ...
        public SendUserPermissionsUpdatedEmail(string userId, string email, string firstName, string tenantId, string organization, string role, IEnumerable<string> authorizedProjects = null)
        {
