...
namespace Ranger.Services.Notifications.Handlers.Email
{
    public class SendPrimaryOwnerTransferAcceptedEmailsHandler : ICommandHandler<SendPrimaryOwnerTransferAcceptedEmails>
    {
        ...
        public SendPrimaryOwnerTransferAcceptedEmailsHandler(ILogger<SendPrimaryOwnerTransferAcceptedEmails> logger, IEmailNotifier emailNotifier, IBusPublisher busPublisher)
        {
            this.logger = logger;
