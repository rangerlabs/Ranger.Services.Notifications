...
{
    public class NotificationsDbContext : DbContext, IDataProtectionKeyContext, IOutboxStore
    {

        private readonly IDataProtectionProvider dataProtectionProvider;
        public NotificationsDbContext(DbContextOptions<NotificationsDbContext> options, IDataProtectionProvider dataProtectionProvider = null) : base(options)
        {
